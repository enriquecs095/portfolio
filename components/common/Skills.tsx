...
import {SiDotnet, SiTerraform, SiJavascript, SiPostgresql, SiTailwindcss, SiVuedotjs} from 'react-icons/si/index';
import {FaAngular,FaDocker, FaAws, FaGitlab} from 'react-icons/fa/index';
                  ...
                  <div className="grid sm:grid-cols-2 grid-cols-1 w-full sm:gap-20  self-center px-20 py-10">
                     <div className="flex  flex-col w-full">
                        ...
                        <div className="py-2 flex">
                           ...
                           <div className="py-2 flex">
                              <FaAngular className="w-10 h-10 " color="699bf7" />
                              <span className="self-center font-medium ml-1">Angular</span>
                           </div>

                           <div className="py-2 flex">
                              <SiTerraform className="w-10 h-10 " color="41b883" />
                              <span className="self-center font-medium ml-1">Terraform</span>
                           </div>
                           <div className="py-2 flex">
                              <FaDocker className="w-10 h-10 " color="41b883" />
                              <span className="self-center font-medium ml-1">Docker</span>
                           </div>
                        </div>
                     ...
                     <div className="py-2 flex">
                        ...
                        <div className="py-2 flex">
                        <FaAws className="w-10 h-10 " color="fafafa" />
                           <span className="self-center font-medium ml-1">AWS Infrastructures</span>
                        </div>
                        ...
                        <div className="py-2 flex">
                           <FaGitlab className="w-10 h-10 " color="fafafa" />
                           <span className="self-center font-medium ml-1">Gitlab CI/CD</span>
                        </div>
                     </div>
                  </div>
               </div>
